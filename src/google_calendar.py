...
def main():
    ...
    # time.
    if os.path.exists("./resources/oauth-token.json"):
        creds = Credentials.from_authorized_user_file("./resources/oauth-token.json", SCOPES)
    ...
    if not creds or not creds.valid:
        ...
        with open("./resources/oauth-token.json", "w") as token:
